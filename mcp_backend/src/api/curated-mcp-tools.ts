 ...
 * logged as "Curated tools missing from local registry" rather than failing loudly.
 *
...
export const V2_TOOL_NAMES = new Set<string>([
  ...
  // Швейцарія (CH) — практика ЄСПЛ: відповідач CHE + провідні рішення важливості 1–3 (HUDOC; LEXAI-2040)
  'ch_search_echr',
  'ch_get_echr_case',
