 ...
 *
 * Covers:
 * - The five ch_* tool names are present in the curated V2_TOOL_NAMES set exposed to
 *   external MCP clients.
 * - ChCourtTools / ChLegislationTools expose exactly those names, each with a
 *   non-empty Ukrainian description and an object-typed inputSchema.
 * - Registering both handlers into a fresh ToolRegistry surfaces all five tools via
...
describe('CH tool surface registration', () => {
  it('V2_TOOL_NAMES contains the five ch_* tools', () => {
  ...
  describe('ToolRegistry registration', () => {
    it('getLocalToolDefinitions includes all five ch_* tools after registering both handlers', () => {
