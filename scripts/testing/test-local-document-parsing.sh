...
# Test document parsing on LOCAL environment
...
echo "=========================================="
echo "Document Parsing Tests - LOCAL Environment"
echo "=========================================="
...
EOF
    ...
    local http_code=$(curl -s -w "%{http_code}" -o "$response_file" \
        -X POST "${LOCAL_URL}/api/tools/parse_document" \
