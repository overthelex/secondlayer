...
### 3. API Tools List ✅
```bash
curl -s -H "Authorization: Bearer c3462787ee0a9b45a1102cc195a65f8ce82c7609242aab5628d4a111c52727b4" \
...
VITE_API_KEY=c3462787ee0a9b45a1102cc195a65f8ce82c7609242aab5628d4a111c52727b4
```
