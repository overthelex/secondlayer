...
- **mcp_backend**: 34 инструмента (порт 3000-3004)
...
#### 17. **bulk_ingest_court_decisions**
...
|--------|-----------|--------------|---------------------|-------------------|
| **mcp_backend** | 3003 | 34 | Судебная практика, юридический анализ, парсинг документов | $0.01-$0.30 |
